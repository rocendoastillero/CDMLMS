...
export default function Schedules({ auth }) {
    return (
        <Layout user={auth.user} icon={headers[5].icon} headerTitle={headers[5].title} headerSubTitle={headers[5].subTitle}>
            ...
            <nav class="nav nav-borders !mb-8">
            ...
            <div className='w-full flex flex-row overflow-x-auto'>
                <div className='flex w-[14.2857142857%] mx-2'>
                    <a class="card lift lift-sm h-100" href="https://request.pnm.edu.ph">
                        <div class="card-body py-5">
                            <h5 class="card-title text-primary mb-2 flex">
                            ...
                            <p class="card-text">Get your your.name@student.pnm.edu.ph email now! Exclusively available for enrolled students of Colegio de Montalban. Go to request.pnm.edu.ph or click this card.</p>
                        </div>
                        <div class="card-footer">
                            <div class="small text-muted">May-30-24</div>
                        </div>
                    </a>
                </div>
                <div className='flex w-[14.2857142857%] mx-2'>
